<div id="create-product-book-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50  hidden">
    <div class="bg-white rounded-md p-10">
        <h2 class="text-lg font-semibold mb-5">Crear producto </h2>
        <form id="edit-product-clothe-form" action="{{ url('/createBook') }}" method="POST" class="flex flex-col">
            @csrf
